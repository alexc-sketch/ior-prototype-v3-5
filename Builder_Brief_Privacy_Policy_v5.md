# Builder Brief: Privacy Policy v5
...
- **Target Filename:** `11f_Privacy_Policyv5.html`
- **Base Template:** `IOR_Utility_Template_Shell_v5.html`
- **Live Reference:** [https://www.ior.com.au/privacy-policy/](https://www.ior.com.au/privacy-policy/)

### 💡 Auditor Note: The Build Strategy (Ultra-Minimal Utility Shell)
This page must be built using the new `IOR_Utility_Template_Shell_v5.html` as the foundation. 
- **KEEP:** Global Header, Proto-Bar, Mobile Drawer, and 6-column Footer.
- **CRITICAL REMOVAL 1:** Remove the Quick Links Bar ("Explore:").
- **CRITICAL REMOVAL 2:** Remove the "Still have questions?" global routing box and the Pre-Footer ("We're here to help"). Legal pages must end abruptly after the text and flow straight into the Global Footer to prevent accidental CTA clicks when users are reading terms.

---

## 2. SEO & Meta Data

- **Meta Title:** Privacy Policy | IOR
- **Meta Description:** Read the IOR Privacy Policy. Learn how we collect, manage, and protect your personal and credit-related information in accordance with the Australian Privacy Principles.
- **Target Keywords:** IOR privacy policy, personal information management, credit reporting policy.
...
- **Style:** Solid brand color (`var(--ior-navy)`). Keep the padding tight.
- **Eyebrow:** LEGAL & COMPLIANCE
- **H1:** Privacy Policy.
- **Subcopy:** This policy outlines how IOR Petroleum Pty Ltd, IOR Aviation Pty Ltd, and related bodies corporate manage personal and credit-related information.
- **CTAs:** None.

### 2. Standard Legal Text Block (The Core Interaction)
- **Visual Reference:** A clean, single-column container centered on the page. Max-width should be restricted (e.g., 800px or 900px) for optimal reading line length. Background should be `var(--white)` sitting on a `var(--grey-50)` page background.
- **Typography Hierarchy:**
  - Use standard `<p>` tags for body copy.
  - Use `<h2>` or `<h3>` tags for the main category headers (e.g., MANAGEMENT OF PERSONAL INFORMATION).
  - Use bold `<h4>` or standard bold text for sub-headers (e.g., How do we collect personal information?).
  - Use standard HTML bulleted lists `<ul>` and `<li>` where applicable.

### 3. Global Footer
- **Style:** Append the standard v4.0 6-column global footer directly below the text container.

---

## 4. Copy Document

*(Dev Note: Please ensure all headings, bolding, and bullet points are formatted exactly as below for legal readability).*
...
In some circumstances, we facilitate you dealing with third parties. Our outdoor payment terminals are operated by Compac (as indicated on the terminals). This privacy policy does not apply to personal information collected by Compac (and any supplier to Compac) through those terminals.
...
We may amend this Privacy Policy from time to time. The most current version of this policy will be located on the intranet for employees and at www.ior.com.au for external users or a copy can be obtained by contacting the Privacy Officer.
